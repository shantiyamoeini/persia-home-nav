...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "دستیار مشاور املاک" },
      {
        name: "description",
        content: "مدیریت املاک، مشتریان و پیگیری‌های روزانه مشاور املاک در یک اپ ساده.",
      },
      { property: "og:title", content: "دستیار مشاور املاک" },
      {
        property: "og:description",
        content: "مدیریت املاک، مشتریان و پیگیری‌های روزانه مشاور املاک.",
      },
